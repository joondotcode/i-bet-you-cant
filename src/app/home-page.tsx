      ...
      <nav className="relative z-10 flex justify-between items-center p-6 max-w-7xl mx-auto">
        <div className="flex items-center space-x-2">
          ...
          <div className="flex items-center space-x-2">
            ...
            <div 
              className="amy-info-tooltip"
              data-tooltip="Stake $15 on daily habits. Complete all days = refund. Miss one = lose it all."
            >
              i
            </div>
          </div>
          <span className="hidden lg:block amy-context-tagline ml-4">
